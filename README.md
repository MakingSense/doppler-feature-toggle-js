...
_TypeScript library starter_ has building UMD and ES5 bundles out of the box, but I want also use it linking the script file to a CDN source. Rollup is ready for that, I configured it using [the convention described by Axel Rauschmayer](http://2ality.com/2017/04/setting-up-multi-platform-packages.html#browser-browser-specific-code)
